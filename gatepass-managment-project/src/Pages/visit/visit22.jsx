...
const StyledContainer = styled(Container)({
  ...
  function Visit22() {
    ...
    const [formData, setFormData] = useState({
        ...
        category: requestToEdit ? requestToEdit.category : '',
        timeslot: requestToEdit ? requestToEdit.timeslot : '',
        note: requestToEdit ? requestToEdit.note : '',
    });
    ...
    const handleConfirmSubmit = () => {
      ...
      axios.put(`http://localhost:4000/updatevisitformone`, dataToSend)
      .then(response => {
